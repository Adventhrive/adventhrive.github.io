<!DOCTYPE html>
<head><script src="https://connect.facebook.net/en_US/sdk.js?hash=a38513a4a3a04727903bc21c83c83c16" async="" crossorigin="anonymous"></script>
    ...
    <meta itemprop="description" content="Free HTML snippets for  HTML CSS JS">
    <meta property="og:url" content="https://bootsnipp.com">
      <meta property="og:image" content="https://bootsnipp.com/img/logo.jpg">
    <meta property="og:site_name" content="Bootsnipp.com">

      <meta property="og:description" content="A design element gallery for web designers and web developers. Find snippets using HTML, CSS, Javascript, jQuery, and .">
    <meta name="description" content="A design element gallery for web designers and web developers. Find snippets using HTML, CSS, Javascript, jQuery, and ">
      <title>Page found!</title>

    <script id="facebook-jssdk" src="//connect.facebook.net/en_US/sdk.js#xfbml=1&amp;version=v2.4&amp;appId=112989545392380"></script><script async="" src="//connect.facebook.net/en_US/fp.js"></script><script async="" src="//www.google-analytics.com/analytics.js"></script><script src="//code.jquery.com/jquery-1.11.0.min.js"></script>
...
<!-- End BuySellAds Ad Code -->
  ...
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <div class="animbrand">
        <a class="navbar-brand animate" href="https://www.instagram.com/adventhrive/" style="display: block; position: fixed; color: rgb(2, 154, 247);">ADVENTHRIVE</a>
      </div>
    </div>
...
-->
	...
	<div class="row">
		<div class="col-sm-12">
			<h1>Hello! Adventhrive page found!</h1>
				<div class="row">
					<div class="col-sm-8">
						
					</div>
					<div class="col-sm-4">
						<h2 style="line-height: 24px; margin-top: 24px; font-weight: 300;">Contact us: </h2>
						<ul>
							<li><a href="https://wa.me/6289697102502" style="text-decoration-color: rgb(5, 148, 29); font-family: &quot;Comic Sans MS&quot;, cursive, sans-serif;">WHATSAPP</a></li>
							<li style="font-family: &quot;Comic Sans MS&quot;, cursive, sans-serif;"><a href="https://s.shopee.co.id/AA82jroxd3" style="text-decoration-color: rgb(134, 107, 9);">SHOPEE</a></li>
							<li><a href="https://preloved.co.id/ADVENTHRIVE" style="font-family: &quot;Comic Sans MS&quot;, cursive, sans-serif;">PRELOVED</a></li>
						</ul>
					</div>
			</div>			
		</div>
